    ...
    <section className="relative min-h-[60vh] flex flex-col items-center justify-center text-center px-4 overflow-hidden bg-gradient-to-r from-sky-100 via-white to-[#E0F8F5]">
      ...
      <div className="z-10 max-w-3xl">
        <h1 className="text-4xl md:text-6xl font-bold leading-tight">
          ...
          <br /> In A <span className="text-purple-600">Smart Way!</span>
        </h1>
        ...
        <div className="mt-8 flex justify-center">
          <div className="flex items-center bg-white shadow-lg rounded-full px-4 w-full max-w-lg">
            ...
            />
            <button className="bg-purple-600 text-white p-3 rounded-full hover:bg-purple-700 transition">
              <FaSearch />
            </button>
          </div>
        </div>
        ...
        <div className="mt-6 flex justify-center gap-4">
          <Link
            to={"/allproduct"}
            className="bg-purple-600 text-white font-medium px-6 py-2 rounded-lg shadow hover:border hover:border-purple-600 hover:bg-transparent hover:text-purple-600 transition cursor-pointer"
          >
            Watch All Products
          </Link>
          <Link
            to={"/create-product"}
            className="border border-purple-600 text-purple-600 font-medium px-6 py-2 rounded-lg hover:bg-purple-600 hover:text-white transition cursor-pointer"
          >
            Post an Product
          </Link>
        </div>
